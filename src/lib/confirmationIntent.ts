...
> = [
  ...
  [
    ...
    ['no', 'cancelar', 'para', 'olvídalo', 'ni hablar'],
  ],
  [
    'pt-BR',
    [
  ...
  [
    ...
    ['non', 'annuler', 'arrête', 'laisse tomber', 'pas question'],
  ],
  [
    'de',
    [
    ...
    ['nein', 'abbrechen', 'stopp', 'vergiss es', 'auf keinen fall'],
  ],
  [
    'it',
    [
    ...
    ['no', 'annulla', 'ferma', 'lascia stare', 'niente'],
  ],
  [
    'ru',
    [
    ...
    ['нет', 'отмена', 'стоп', 'забудь', 'не надо'],
  ],
  [
    'ar',
    [
  ...
  [
    ...
    ['नहीं', 'रद्द', 'रुको', 'छोड़ो', 'मत'],
  ],
  [
    'bn',
    ['হ্যাঁ', 'ঠিক', 'সঠিক', 'পাঠাও', 'নিশ্চিত', 'ওকে', 'অবশ্যই', 'চলো'],
    ['না', 'বাতিল', 'থামো', 'ভুলে যাও'],
  ],
  [
    'ur',
    ['ہاں', 'جی', 'صحیح', 'بھیجو', 'تصدیق', 'ٹھیک', 'بالکل', 'چلو', 'اوکے'],
    ['نہیں', 'منسوخ', 'رکو', 'چھوڑو', 'مت'],
  ],
  [
    'vi',
    [
  ...
  [
    ...
    ['tidak', 'batal', 'stop', 'lupakan', 'jangan'],
  ],
  [
    'ms',
    [
    ...
    ['tidak', 'batal', 'hentikan', 'lupakan', 'jangan'],
  ],
  [
    'tl',
    ['oo', 'tama', 'ipadala', 'kumpirmahin', 'ok', 'sige', 'ayan', 'sigurado'],
    ['hindi', 'kanselahin', 'huwag', 'kalimutan', 'ayaw'],
  ],
  [
    'tr',
    [
