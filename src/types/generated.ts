...
{ EchoRestored: { echo_id: string } } | { TickStarted: { tick_id: number } } | { TickCompleted: { tick_id: number } } | { DiaryEntryGenerated: { echo_id: string; diary_id: string } } | { LifeEventOccurred: { echo_id: string; event_id: string } } | { MoodChanged: { echo_id: string; old_mood: string; new_mood: string } } | { EchoInteraction: { echo_a: string; echo_b: string; interaction_type: string; tick_id: number } } | 
